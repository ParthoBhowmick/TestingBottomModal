...
import com.example.testingmodalbottom.R;
import com.example.testingmodalbottom.library.provider.ResourceProvider;
import com.example.testingmodalbottom.library.provider.ScreenInfoProvider;
...
import com.example.testingmodalbottom.library.ui.interfaces.IScrollViewListener;
import com.example.testingmodalbottom.library.ui.presentation.IStickyScrollPresentation;
import com.example.testingmodalbottom.library.ui.presenter.StickyScrollPresenter;
...
public class StickyScrollView extends ScrollView implements IStickyScrollPresentation {
    ...
    public StickyScrollView(Context context, AttributeSet attrs, int defStyle) {
        ...
        IScreenInfoProvider screenInfoProvider = (IScreenInfoProvider) new ScreenInfoProvider(context);
        IResourceProvider resourceProvider = (IResourceProvider) new ResourceProvider(context, attrs, R.styleable.StickyScrollView);
